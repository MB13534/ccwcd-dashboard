...
const RechargeDataLag = props => {
  ...
  const [LagStatusData] = useFetchData(`recharge-accounting/lag/status/${activeYear}/${activeMonth}`, [
    activeYear,
    activeMonth,
    refreshSwitch,
  ]);
  const [UnlaggedRechargeSlices, isLoading] = useFetchData('recharge-accounting/flags/unlagged', [refreshSwitch]);
      ...
      <Paper elevation={0} className={classes.paper}>
        ...
        <InfoCard mt={2}>
          <Typography variant="body1">
            Use the form below to select the year and month that you would like to lag recharge data for. Please ensure
            that you have resolved all errors in the data in the previous steps before lagging the data. Note: the
            lagging process can take over a minute to run.
          </Typography>
        </InfoCard>
        <Box mt={2} mb={2}>
          <form method="post" onSubmit={handleSubmit}>
            ...
            <Box mt={2} mb={2} ml={1} mr={1}>
              ...
              <Typography variant="body1">
                The following table provides a summary of recharge data that has yet to be lagged.
              </Typography>
              <MaterialTable
            ...
            <Box mt={2} mb={2}>
              <Button variant="contained" component={Link} to="/recharge-accounting/data/process/qaqc">
                Back
              </Button>
              <Button
                variant="contained"
