...
import RechargeDataSplits from './RechargeDataProcessing/RechargeDataSplits';
...
const RechargeAccounting = () => {
  ...
  return (
    <Switch>
      <PrivateRouteWithRoles path={url} exact roles={AdminRoles} component={Home} />
      <PrivateRouteWithRoles path={`${url}/water-slices`} exact roles={AdminRoles} component={WaterSlices} />
      <PrivateRouteWithRoles path={`${url}/splits/:id`} exact roles={AdminRoles} component={Splits} />
      <PrivateRouteWithRoles path={`${url}/splits/:id/default`} exact roles={AdminRoles} component={DefaultSplits} />
      ...
      />
      <PrivateRouteWithRoles path={`${url}/data/process/qaqc`} exact roles={AdminRoles} component={RechargeDataQAQC} />
      <PrivateRouteWithRoles
        path={`${url}/data/process/splits`}
        exact
        roles={AdminRoles}
        component={RechargeDataSplits}
      />
      <PrivateRouteWithRoles path={`${url}/data/process/lag`} exact roles={AdminRoles} component={RechargeDataLag} />
      <PrivateRouteWithRoles
