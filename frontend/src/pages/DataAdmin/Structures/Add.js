...
import useFetchData from '../../../hooks/useFetchData'; // import our custom hook for fetching list items
...
const AddStructures = (props) => {
   ...
   * It is run after a successful form submission
   */
  const resetForm = () => {
    let obj = {};
      ...
      <div className={classes.content}>
        <section className={classes.row}>
          <div className={classes.pageTitleBar}>
            <Typography variant="h5" color="secondary" className={classes.title}>Add New Structure</Typography>
          ...
          <Paper className={classes.dashboardMain}>
            <form onSubmit={handleSubmit} method="post">
              ...
              <section className={classes.marginTop}>
                <Typography variant="h6" color="secondary" className={classes.title}>Meausurements for this structure</Typography>
                <Table
...
AddStructures.propTypes = {
  history: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(AddStructures);
