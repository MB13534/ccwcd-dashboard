...
const { MonthlyLaggedRecharge } = require("../../models");
...
// GET /api/monthly-lagged-recharge
// Route for returning daily data averages
router.get("/", (req, res, next) => {
  const { recharge_slices, start_date, end_date, plans, format = "json" } = req.query;
